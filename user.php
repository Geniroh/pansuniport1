    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a href="index.php" class="navbar-brand">
          <img src="assets/img/panslogo.png" alt="" style="width: 100px; height:100%;">
        </a>
      </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="./rxmall">Buy on RxMall</a></li>
                <li class="nav-item"> <a class="nav-link" href="user.php?x=8">Sell on RxMall</a></li>
              </ul>
            </div>
          </li>

          <!-- <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#rxmall" aria-expanded="false" aria-controls="ui-basic">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title">RxMall</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="rxmall">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="user.php?x=6">Buy Item</a></li>
                <li class="nav-item"> <a class="nav-link" href="construct.html">Sell on rxmall</a></li>
              </ul>
            </div>
          </li> -->
        ...
        <div class="content-wrapper">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <b>PANS UNIPORT</b> 2022. All rights reserved.</span>
