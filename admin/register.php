                            ...
                            <div class="text-center">
                                ...
                                <div class="overflow-hidden" style="max-height: 30vh;">
                                    <div class="container px-5">
                                        <img src="img/undraw_profile_1.svg" class="img-fluid border rounded-3 shadow-lg mb-4" alt="Example image" width="700" height="500" loading="lazy">
                                    </div>
                                </div>
                            </div>
                            <h4>How to Navigate</h4>
                            <p>First Ensure that you have been given the pin that will allow for you to register and login in subsequently. If not contact the technical team for more enquires <a href="mailto:support@pansuniport.com">click here to contact</a>
                            <ul>
