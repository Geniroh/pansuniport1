        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row cn-slider">
                        <?php
                        $query = "SELECT * FROM post WHERE post_category_id = 11 ORDER BY post_id DESC LIMIT 10";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row cn-slider">
                        <?php
                        $query = "SELECT * FROM post WHERE post_category_id = 13 ORDER BY post_id DESC LIMIT 10";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row cn-slider">
                        <?php
                        $query = "SELECT * FROM post WHERE post_category_id = 4 ORDER BY post_id DESC LIMIT 10";
                ...
                <div class="col-md-12">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="featured" class="container tab-pane active">
                            <?php
                            $query = "SELECT * FROM post WHERE post_desc = 'featured' ORDER BY post_id DESC LIMIT 3";
                        ...
                        <div id="popular" class="container tab-pane fade">
                            <?php
                            $query = "SELECT * FROM post WHERE post_desc = 'popular' ORDER BY post_id DESC LIMIT 3";
