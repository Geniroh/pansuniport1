            ...
            if (!preg_match("/^[a-zA-Z]*$/", $first_name) || !preg_match("/^[a-zA-Z]*$/", $last_name) ) {
                ...
                if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
                    ...
                    if ($resultCheck > 0) {
                        ...
                        $sql = "INSERT INTO users (first_name, last_name, mat_no, gender, user_phone, exco, email, user_pwd, mob) VALUES ('$first_name', '$last_name', '$mat_no', '$gender', '$user_phone', '$exco', '$email', '$hashedPwd', '$mob');";
