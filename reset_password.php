...
<body>
    <form class="form-signin" >
        ...
        <div class="form-label-group">
            <input type="email" id="user_pwd" name="user_pwd" class="form-control" placeholder="Enter Password" required>
            <label for="email">Enter your Email</label>
        </div>
  
        <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">Receive New Password By Mail</button>
